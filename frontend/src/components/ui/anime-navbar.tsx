...
export function AnimeNavBar({ items, className, defaultActive = "Home", alignment = "center" }: NavBarProps) {
    ...
    return (
        <div className={cn("fixed top-5 left-0 right-0 z-[9999] pointer-events-none", className)}>
            <div className={cn("flex pt-6 pointer-events-auto", alignment === "center" ? "justify-center" : "justify-end pr-8")}>
                <motion.div
