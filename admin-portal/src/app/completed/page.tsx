...
export default function CompletedReports() {
    ...
    const fetchReports = async () => {
        try {
            ...
            setReports(allReports.filter(r => r.status === 'Completed'));
            setError(null);
        } catch (err: unknown) {
            console.error(err);
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-white">Completed Reports</h1>
                    <p className="text-muted-foreground mt-1">Closed and resolved cases.</p>
                </div>
            ...
            <div className="rounded-xl border border-border bg-card overflow-hidden">
                <div className="p-6 border-b border-border">
                    <h3 className="font-semibold text-white">Completed Cases</h3>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="p-12 text-center text-muted-foreground">No completed reports found.</div>
                ) : (
                    <>
                        {/* Desktop Table */}
