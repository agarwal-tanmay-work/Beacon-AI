...
from app.api.v1 import files as admin_files
...
app.include_router(admin_files.router, prefix=f"{settings.API_V1_STR}/files", tags=["files"]) # Generic endpoint /api/v1/files
